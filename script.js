...
function removeActive(b, t){
  ...
  re.forEach(function(at){
    ...
    var CS_btn = document.querySelector(".CS_btn");
    var CS = document.querySelector("#CS");
    CS_btn.addEventListener("click",function(){
      CS.classList.add("active");
    });

    var CS_btn1 = document.querySelector(".design_btn");
    CS_btn1.addEventListener("click",function(){
      CS.classList.add("active");
    });
    
    var CS_close = document.querySelector(".remove");
    CS_close.addEventListener("click",function(){
